  ...
  return { score: 98, status: "READY" };
      ...
      <div className="w-full max-w-md bg-paper-bg border border-ink-black p-8 flex flex-col gap-6 sharp-corners hard-shadow-hover z-10">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <h2 className="text-xl font-serif font-black tracking-tight text-ink-black uppercase">Get Started with CodeMind</h2>
          <p className="text-[10px] font-mono tracking-widest uppercase text-neutral-500">Sign up in seconds to start codebase audits.</p>
        </div>
        ...
        <span className="text-center text-[10px] font-mono uppercase tracking-wider text-neutral-500 border-t border-ink-black pt-4">
          ...
          <Link href="/login" className="text-ink-black font-bold underline hover:text-editorial-red transition-colors">
            Sign In instead
          </Link>
        </span>
